...
const languages: Languages = {
    "zh-CN": {
        ...
        "Any Metal Volcano": "任意金属火山",
        "World Traits": "星球特质",
        "Geyser Filters": "喷泉/火山筛选",
        "Add Filter": "添加筛选条件",
        Remove: "删除",
        Target: "目标",
        Minimum: "最小值",
        Maximum: "最大值",
        "No geyser filters": "未添加喷泉/火山筛选条件",
        "Matched all filters.": "已命中全部筛选条件。",
        "Returned closest match after search.": "未找到完全匹配结果，已返回最接近结果。",
        "Search attempts": "搜索次数",
        "No Traits": "没有不寻常的特质",
